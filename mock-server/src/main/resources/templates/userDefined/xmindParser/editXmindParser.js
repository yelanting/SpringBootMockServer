layui.use([
	...
	form.on("submit(editXmindParserSubmit)", function(data) {
		// 弹出loading
		...
		var postData = $("#editXmindParserForm").serialize();
		
		// 实际使用时的提交信息
		$.post("/xmindParser/updateXmindParser", postData, function(response) {
