layui.use([
	...
	form.on("submit(editOtherAddressSubmit)", function(data) {
		// 弹出loading
		var index = top.layer.msg('数据提交中，请稍候', {
			icon : 16, time : false, shade : 0.8
		});

		var postData = $("#editOtherAddressForm").serialize();
		
		// 实际使用时的提交信息
		$.post("/otherAddress/updateOtherAddress", postData, function(response) {
